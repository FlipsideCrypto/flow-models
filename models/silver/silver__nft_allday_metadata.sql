...
FINAL AS (
    SELECT
        ...
        DATA :edition :play :metadata :playerFullName :: STRING AS player,
        DATA :edition :play :metadata: teamName :: STRING AS team,
        DATA :edition :play :metadata :season :: STRING AS season,
        DATA :edition :play :metadata: week AS week,
        DATA :edition :play :metadata: classification AS classification,
        ...
        DATA :set :name :: STRING AS set_name,
