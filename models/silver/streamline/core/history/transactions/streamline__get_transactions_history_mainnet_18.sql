{{ config (
    ...
    post_hook = if_data_call_function(
        func = "{{this.schema}}.udf_bulk_grpc_us_east_2(object_construct('sql_source', '{{this.identifier}}','node_url','access-001.mainnet18.nodes.onflow.org:9000','external_table', 'transactions_mainnet_18', 'sql_limit', 225000, 'producer_batch_size','1250', 'worker_batch_size', '10', 'batch_call_limit', {{var('batch_call_limit','1')}}))",
