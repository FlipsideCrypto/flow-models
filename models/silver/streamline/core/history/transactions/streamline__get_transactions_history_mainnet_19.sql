{{ config (
    ...
    post_hook = if_data_call_function(
        func = "{{this.schema}}.udf_bulk_grpc(object_construct('sql_source', '{{this.identifier}}','node_url','access-001.mainnet19.nodes.onflow.org:9000','external_table', 'transactions_mainnet_19', 'sql_limit', '750000', 'producer_batch_size','25000', 'worker_batch_size', '400', 'batch_call_limit', {{var('batch_call_limit','1')}}))",
